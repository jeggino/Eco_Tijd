...
if project:
  ...
  if opdracht:
    ...
    if level:
      st.write(df[(df['project']==project)&(df['opdracht']==opdracht)&(df['level']==level)]['n_hours'].values)
      if df[(df['project']==project)&(df['opdracht']==opdracht)&(df['level']==level)]['n_hours'].values == 0:
        ...
        aantal_uren = df[(df['project']==project)&(df['opdracht']==opdracht)&(df['level']==level)]['n_hours'].values
