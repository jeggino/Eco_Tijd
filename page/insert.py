...
with st.form("my_form", clear_on_submit=True,border=True): 
  ...
  kind_of_hours = st.radio('Soort projecturen', ['Vast', 'Niet vast'], index=0, format_func=special_internal_function, key=None, help=None, on_change=None, args=None, kwargs=None, disabled=False, horizontal=False, captions=None, label_visibility="visible", width="content")
